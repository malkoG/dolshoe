...
/**
 * A project's Logs screen: the volume chart and either the record list or
 * the live-console stub.
 *
 * @remarks
 * Values in, pixels out. The route fetches; a construction test and a
 * silhouette inject a named state. Sidebar, top bar, and page-shell stay
 * where they are — this view owns the heading and the two panels below it.
 */
