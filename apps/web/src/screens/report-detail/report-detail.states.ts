...
const typeError: NormalizedException = {
  ...
  frames: [
    ...
    libraryFrame("handle", "node_modules/express/lib/router/index.js", 166),
    libraryFrame("Layer.handle_request", "node_modules/express/lib/router/layer.js", 95),
    libraryFrame("trim_prefix", "node_modules/express/lib/application.js", 191),
  ...
  cause: {
    ...
    frames: [
      ...
      libraryFrame("request", "node_modules/stripe/lib/StripeResource.js", 210),
    ],
  },
};
