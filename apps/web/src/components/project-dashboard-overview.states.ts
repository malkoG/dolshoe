...
function empty(): ProjectDashboardOverviewProps {
  const summary: ProjectDashboardSummary = {
    ...
    logRecords: { total: 0, lastOccurredAt: null },
    traces: { total: 0, lastOccurredAt: null },
...
function populated(): ProjectDashboardOverviewProps {
  ...
  const summary: ProjectDashboardSummary = {
    ...
    errorReports: {
      ...
      lastOccurredAt: "2026-09-09T08:12:00.000Z",
    },
    logRecords: { total: 512, lastOccurredAt: "2026-09-09T08:14:00.000Z" },
    traces: { total: 133, lastOccurredAt: "2026-09-09T07:40:00.000Z" },
